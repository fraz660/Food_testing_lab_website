...
const Home = () => {
  ...
  return (
    <div className="min-h-screen">
          ...
          >
            <div className="space-y-3 md:space-y-4">
              <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-6xl font-bold leading-tight drop-shadow-lg">
                ...
                <span className="block text-green-300">Laboratory Pvt. Ltd.</span>
              </h1>
            ...
            <div className="flex flex-col sm:flex-row gap-3 md:gap-4 justify-center items-center px-4">
              <Link
                to="/services"
                className="w-full sm:w-auto bg-green-500 text-white px-6 md:px-8 py-3 md:py-4 rounded-full font-semibold hover:bg-green-400 transition-all duration-300 transform hover:scale-105 flex items-center justify-center space-x-2 shadow-lg"
              >
              ...
              <Link
                to="/contact"
                className="w-full sm:w-auto border-2 border-white text-white px-6 md:px-8 py-3 md:py-4 rounded-full font-semibold hover:bg-white hover:text-green-900 transition-all duration-300 transform hover:scale-105 backdrop-blur-sm bg-white bg-opacity-10"
              >
                Get Quote
              </Link>
            </div>
            ...
            <div className="flex flex-col sm:flex-row justify-center items-center space-y-2 sm:space-y-0 sm:space-x-8 pt-4 md:pt-8">
              <div className="flex items-center space-x-2 bg-green-500 bg-opacity-20 backdrop-blur-sm px-4 py-2 rounded-full border border-green-400/30">
                <FaCertificate className="h-5 w-5 md:h-6 md:w-6 text-green-400" />
                <span className="text-xs md:text-sm font-medium">NABL Accredited</span>
              </div>
              {/* <div className="flex items-center space-x-2 bg-green-500 bg-opacity-20 backdrop-blur-sm px-4 py-2 rounded-full">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-wrap justify-center items-center gap-6 md:gap-12">
            <div className="flex items-center space-x-2 text-gray-700">
              ...
              <div>
                <div className="text-xs font-bold text-gray-900 uppercase tracking-wide">NABL</div>
                <div className="text-xs text-gray-500">Accredited Lab</div>
              </div>
            </div>
            ...
            <div className="flex items-center space-x-2 text-gray-700">
              ...
              <div>
                <div className="text-xs font-bold text-gray-900 uppercase tracking-wide">FSSAI</div>
            ...
            <div className="flex items-center space-x-2 text-gray-700">
              ...
              <div>
                <div className="text-xs font-bold text-gray-900 uppercase tracking-wide">Centurion</div>
            ...
            <div className="flex items-center space-x-2 text-gray-700">
              <div className="w-10 h-10 bg-green-100 rounded-full flex items-center justify-center">
                <FaCogs className="h-5 w-5 text-green-600" />
              </div>
              <div>
                <div className="text-xs font-bold text-gray-900 uppercase tracking-wide">20+</div>
            ...
            >
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div className="p-4 bg-red-50 rounded-lg">
                  <FaFlask className="h-6 w-6 md:h-8 md:w-8 text-green-600 mb-2" />
                ...
                <div className="p-4 bg-orange-50 rounded-lg">
                  <FaCertificate className="h-6 w-6 md:h-8 md:w-8 text-green-600 mb-2" />
              ...
              >
                <div className="flex items-center space-x-3 md:space-x-4 mb-4 md:mb-6">
                  <div className="p-2 md:p-3 bg-green-100 rounded-full">
                    <service.icon className="h-6 w-6 md:h-8 md:w-8 text-green-600" />
                  </div>
                ...
                <div className="mt-4 md:mt-6">
                  <Link
                    to="/services"
                    className="text-green-600 hover:text-green-700 font-medium flex items-center space-x-2 group text-sm md:text-base"
                  >
      ...
      {/* Stats Section */}
      <section ref={statsRef} className="py-12 md:py-20 bg-green-600 text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div
            initial={{ opacity: 0, y: 50 }}
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 md:gap-8">
            {stats.map((stat, index) => (
              ...
              >
                <div className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-green-400 mb-2">
                  {stat.value}
                </div>
      ...
      <section ref={equipmentRef} className="py-12 md:py-20 bg-gray-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mt-8 md:mt-12">
            <Link
              to="/equipment"
              className="bg-green-600 text-white px-6 md:px-8 py-3 md:py-4 rounded-full font-semibold hover:bg-green-700 transition-all duration-300 transform hover:scale-105 text-sm md:text-base"
            >
              View All Equipment
            </Link>
          </div>
      ...
      <section ref={teamRef} className="py-12 md:py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8">
            {[
              { name: 'Dr. Preetha Bhadra', role: 'Managing Director', img: '/Dr.Preetha Bhadra.jpg' },
              { name: 'Dr. Bhadram Kalyan C.', role: 'Technical Manager (Chemical)', img: '/Dr.Bhadram.jpg' },
              { name: 'Dr. Pratyush Kumar Das', role: 'Technical Manager (Biological)', img: '/Dr.Prathyush.jpg' },
              { name: 'Mr. Victor Pradhan', role: 'Senior Analyst (Chemical)', img: '/Mr.Victor.jpg' }
            ].map((member, index) => (
              <motion.div
                key={index}
                initial={{ opacity: 0, y: 30 }}
              ...
              >
                <div className="w-20 h-20 md:w-24 md:h-24 bg-green-100 rounded-full mx-auto mb-3 md:mb-4 flex items-center justify-center overflow-hidden">
                  {member.img ? (
                    <img
                      src={member.img}
                      alt={member.name}
                  ...
                  <span
                    className="text-lg font-bold text-green-600 flex items-center justify-center w-full h-full"
                ...
                <p className="text-green-600 font-medium text-sm md:text-base">{member.role}</p>
              </motion.div>
            ))}
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12 items-center">
            ...
            >
              ...
              <ul className="space-y-2 md:space-y-3">
                {['Food testing', 'Pharmaceutical analysis', 'Microbiology', 'Molecular techniques', 'Animal cell culture', 'In silico analysis'].map((area, index) => (
                  <li key={index} className="flex items-center space-x-3">
                    <FaCheckCircle className="h-4 w-4 md:h-5 md:w-5 text-green-600 flex-shrink-0" />
              ...
              <div className="mt-6 md:mt-8">
                <Link
                  to="/internship"
                  className="w-full bg-green-600 text-white px-4 md:px-6 py-2 md:py-3 rounded-lg font-semibold hover:bg-green-700 transition-all duration-300 block text-center text-sm md:text-base"
                >
                  Apply Now
                </Link>
              </div>
            ...
            {recentBlogs.map((blog, index) => (
              ...
              >
                <div className="p-4 md:p-6">
                  ...
                  <Link
                    to={`/blog/${blog.slug}`}
                    className="text-green-600 hover:text-green-700 font-medium flex items-center space-x-2 text-sm md:text-base"
                  >
                    <span>Read More</span>
                    <FaArrowRight className="h-4 w-4" />
                  </Link>
            ...
            >
              ...
              <form onSubmit={handleContactSubmit} className="space-y-4 md:space-y-6">
                ...
                <button
                  ...
                  className={`w-full px-4 md:px-6 py-2 md:py-3 rounded-lg font-semibold transition-all duration-300 text-sm md:text-base ${contactLoading
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-3 md:gap-4 justify-center px-4">
              <Link
                to="/contact"
                className="w-full sm:w-auto bg-green-600 text-white px-6 md:px-8 py-3 md:py-4 rounded-full font-semibold hover:bg-green-700 transition-all duration-300 transform hover:scale-105 text-sm md:text-base"
              >
                Get Quote
              </Link>
              <Link
                to="/internship"
                className="w-full sm:w-auto border-2 border-green-600 text-green-600 px-6 md:px-8 py-3 md:py-4 rounded-full font-semibold hover:bg-green-600 hover:text-white transition-all duration-300 transform hover:scale-105 text-sm md:text-base"
              >
